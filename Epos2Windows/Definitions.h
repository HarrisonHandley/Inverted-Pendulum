...
**
** File:            Definitions.h
** Description:     Functions definitions for EposCmd.dll/EposCmd64.dll library for
...
//General
    ...
    Configuration_DllExport BOOL __stdcall VCS_ExportParameter(HANDLE KeyHandle, WORD NodeId, char *pParameterFileName, char *pBinaryFile, char *pUserID, char *pComment, BOOL ShowDlg, BOOL ShowMsg, DWORD *pErrorCode);
